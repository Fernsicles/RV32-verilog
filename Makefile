...
verilated.o: /usr/share/verilator/include/verilated.cpp
	g++ -std=c++17 -c -O5 /usr/share/verilator/include/verilated.cpp

CPU_sim: obj_dir/VCPU.h CPU_sim.cpp verilated.o
	g++ -std=c++17 -Wall -g -O5 -pthread -Dcimg_display=1 -Iobj_dir $(shell pkg-config --cflags verilator) CPU_sim.cpp verilated.o obj_dir/VCPU__ALL.o $(shell pkg-config --libs x11) -o CPU_sim